...
from mybot.agent.memory import Consolidator, Dream
...
from mybot.command import CommandContext, CommandRouter, register_builtin_commands
...
from mybot.utils.helpers import image_placeholder_text, truncate_text
from mybot.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE

if TYPE_CHECKING:
    from mybot.config.schema import ChannelsConfig, ExecToolConfig, WebToolsConfig
...
class _LoopHook(AgentHook):
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        from mybot.utils.helpers import strip_think
...
class AgentLoop:
    ...
    def __init__(
        ...
        # MYBOT_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("MYBOT_MAX_CONCURRENT_REQUESTS", "3"))
