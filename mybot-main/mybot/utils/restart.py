...
RESTART_NOTIFY_CHANNEL_ENV = "MYBOT_RESTART_NOTIFY_CHANNEL"
RESTART_NOTIFY_CHAT_ID_ENV = "MYBOT_RESTART_NOTIFY_CHAT_ID"
RESTART_STARTED_AT_ENV = "MYBOT_RESTART_STARTED_AT"
